...
async function getData({category} : ProductRowProps) {
    switch(category) {
        ...
        case "newest": {
            ...
            return { data, title: "Newest Products", link : '/products/any'};
        }
        case "template": {
            const data = await prisma.product.findMany({
    ...
    return (
        ...
        <section className="mt-12">
            <div className="md:flex md:items-center md:justify-between">
                ...
                <Link href={data.link} className="text-sm hidden font-medium text-blue-600 hover:text-blue-600/90 md:block">
